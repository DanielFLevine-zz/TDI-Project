...
os.chdir(r'C:\Users\Daniel\Desktop\Python Projects\Twitch_data\ICWSM19_data')

#Returns a list of all global Twitch emotes.

global_response = requests.get('https://api.twitch.tv/kraken/chat/emoticon_images?emotesets=0',headers = {'Accept': 'application/vnd.twitchtv.v5+json','Client-ID': '4f7ls48eaq2lly25dyuiead8o5ydev'})
